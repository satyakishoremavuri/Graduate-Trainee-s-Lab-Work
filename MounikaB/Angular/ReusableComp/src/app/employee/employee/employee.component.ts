...
export class EmployeeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.person = this._testService.getData("Mounika", "Boinapally");
    this.employees = [
      { empNumber: 101, empName: 'Mounika', empSalary: 85000, empAddress: "Hyderabad" },
      { empNumber: 102, empName: 'Hira', empSalary: 65000, empAddress: "Chennai" },
      { empNumber: 103, empName: 'Divya', empSalary: 75000, empAddress: "Vijayawada" },
