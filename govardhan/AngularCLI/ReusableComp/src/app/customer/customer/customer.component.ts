...
export class CustomerComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.customers = [
      { custNumber: 1, custName: 'Sathesh', custAmount: 6500, custAddress: 'Chennai' },
      { custNumber: 2, custName: 'Rama', custAmount: 5500, custAddress: 'Hyderabad' },
      { custNumber: 3, custName: 'Krishna', custAmount: 4500, custAddress: 'Pune' },
